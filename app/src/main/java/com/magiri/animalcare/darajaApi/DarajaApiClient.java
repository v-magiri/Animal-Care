...
import static com.magiri.animalcare.darajaApi.Constants.BASE_URL;
import static com.magiri.animalcare.darajaApi.Constants.CONNECT_TIMEOUT;
import static com.magiri.animalcare.darajaApi.Constants.READ_TIMEOUT;
import static com.magiri.animalcare.darajaApi.Constants.WRITE_TIMEOUT;
...
public class DarajaApiClient {
    ...
    public RestClient mpesaService() {
        return getRestAdapter().create(RestClient.class);
    }
}
